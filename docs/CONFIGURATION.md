...
freeze-on-select = false   # hold the screen still while selecting; a drag selects even in apps that take the mouse
copy-on-select = true      # copy a drag selection to the clipboard on release
confirm-close = true
