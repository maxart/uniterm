...
| Logical lines and width reflow | Shipped | `uniterm_core::grid::Grid::resize` | `soft_wrapped_lines_reflow_and_cursor_follows_text`, `one_column_reflow_preserves_wide_text_for_later_growth` | DC3 |
