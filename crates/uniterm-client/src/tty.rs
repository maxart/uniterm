...
/// alternate screen, reset character sets, drawing modes and attributes, and show the
...
/// Sent on attach: cancel an unfinished escape, select ASCII in G0/G1 and
/// invoke G0 (SI), then enter the alternate screen with known drawing modes.
/// SGR alone does not undo DEC line drawing (`printf '\033(0'`) or SO.
/// Normalize character sets before saving the main-screen cursor: terminals
/// may save/restore the character set along with it. Avoid RIS (`ESC c`) or an
/// external `reset`, which can erase the user's shell screen and scrollback.
/// Reset origin, horizontal margins, insert, reverse-screen, cursor-key and
/// keypad modes before clearing/positioning the first frame. This is one
/// fixed write per attach, with no work on the render or idle paths.
///
...
pub(crate) const TERM_SETUP: &[u8] =
    b"\x18\x1b]777;uniterm-input;1\x07\x1b(B\x1b)B\x0f\x1b[m\x1b[?1049h\x1b[?2026l\x1b[?6l\x1b[?69l\x1b[4l\x1b[?5l\x1b[?1l\x1b>\x1b[r\x1b[m\x1b[?7l\x1b[?25h\x1b[2J\x1b[H\x1b[?1000h\x1b[?1002h\x1b[?1003l\x1b[?1004h\x1b[?1006h";
...
/// Reassert ASCII and default attributes after the saved cursor is restored.
pub(crate) const TERM_RESTORE: &[u8] =
    b"\x18\x1b]777;uniterm-input;0\x07\x1b[?1000l\x1b[?1002l\x1b[?1003l\x1b[?1004l\x1b[?1006l\x1b[m\x1b[?7h\x1b[?25h\x1b[?1049l\x1b(B\x1b)B\x0f\x1b[m";
...
mod tests {
    ...
    fn tty_lifecycle_marks_nested_input_and_keeps_mouse_enabled() {
        assert!(TERM_SETUP.starts_with(b"\x18\x1b]777;uniterm-input;1\x07"));
        ...
        assert!(TERM_RESTORE.starts_with(b"\x18\x1b]777;uniterm-input;0\x07"));
    }
